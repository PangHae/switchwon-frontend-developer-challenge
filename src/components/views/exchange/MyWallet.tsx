			...
			<CardContent className="flex flex-col gap-4 flex-1">
				<ul className="flex flex-col gap-4 flex-1 text-xl font-medium">
					<li className="flex justify-between items-center">
						...
						<span className="text-gray-700 font-semibold">₩ 1,200,000</span>
					</li>
					<li className="flex justify-between items-center">
						<span className="text-gray-700">USD</span>
						<span className="text-gray-700 font-semibold">$ 50,000</span>
					</li>
					<li className="flex justify-between items-center">
						<span className="text-gray-700">JPY</span>
						<span className="text-gray-700 font-semibold">₩ 150,000</span>
					</li>
				</ul>
				<Separator />
